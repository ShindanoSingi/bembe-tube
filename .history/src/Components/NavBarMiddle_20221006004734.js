...
const NavBarMiddle = ({
     ...
     return(
     // <BottomNavigation sx={{ width: 500 }} value={value} onChange={handleChange}> <div className="hidden nav-bar-middle md:block md:flex-row md:h-6 md:row"> <div> <PlayingVideoInfo videoObject={videoObject}
          viewsFunc = {
          viewsFunc
     }
     getaddToPlaylist = {
          getaddToPlaylist
     } /> </div>< div > <BottomNavigationAction className=""
