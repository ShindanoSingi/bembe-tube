...
const NavBarMiddle = ({
     ...
     return (
          <div className=" bg-[#1E1E1E]  md:flex md:justify-between min-w-screen mx-2 md:justify-evenly ">
               <PlayingVideoInfo videoObject={videoObject}
                    viewsFunc={viewsFunc}
                    getaddToPlaylist={getaddToPlaylist}/>

               <addIcon className="invisible text-white md:visible" onClick= {() => { addToPlaylist()
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           getPlayList()}}/>
               <LocationOnIcon className="invisible md:visible"/>
               <FolderIcon className="invisible md:visible"/>
          </div>
     );
}
