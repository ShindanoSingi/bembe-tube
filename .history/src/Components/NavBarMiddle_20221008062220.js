...
const NavBarMiddle = ({
     ...
     return (
          <div className=" bg-[#1E1E1E] flex justify-around  md:flex md:justify-around max-w-screen ">
               <PlayingVideoInfo videoObject={videoObject}
                    viewsFunc={viewsFunc}
                    getaddToPlaylist={getaddToPlaylist}/>

               <addIcon className="hidden text-white md:block" onClick= {() => { addToPlaylist()
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               getPlayList()}}/>
               <LocationOnIcon className="hidden md:block"/>
               <FolderIcon className="hidden md:block"/>
          </div>
     );
}
