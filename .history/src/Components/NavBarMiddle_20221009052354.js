...
const NavBarMiddle = ({
     ...
     return (
          <div className=" bg-[#1E1E1E] flex justify-between items-center px-4 w-screen ">
               ...
               <addIcon className="hidden text-white md:block fill-gray-300" onClick= {() => { addToPlaylist()
                                                                                                                                                                                                                                                getPlayList()}}/>
               <LocationOnIcon className="invisible md:visible fill-gray-300"/>
               <FolderIcon className="invisible md:visible fill-gray-300"/>
          </div>
     );
}
