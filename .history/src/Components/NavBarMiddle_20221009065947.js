...
const NavBarMiddle = ({
     ...
     return (
          <div className=" bg-[#1E1E1E] md:flex md:justify-around md:w-screen md:py-2 md:items-center">
               <PlayingVideoInfo videoObject={videoObject}
                    viewsFunc={viewsFunc}
                    getaddToPlaylist={getaddToPlaylist}/>

               <LibraryAddIcon className="text-red-600 add-to-playlist" onClick= {() => { addToPlaylist()
                                                                                                                                                                                                                                                                                                                                getPlayList()}}/>
