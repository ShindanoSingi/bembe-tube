...
const NavBarMiddle = ({
     ...
     return (
          <div className=" bg-[#1E1E1E] md:flex md:justify-around md:w-screen md:py-4 md:items-center">
               <PlayingVideoInfo videoObject={videoObject}
                    viewsFunc={viewsFunc}
                    getaddToPlaylist={getaddToPlaylist}/>

               <PlaylistAddIcon className="scale-125 text-stone-400 add-to-playlist" onClick= {() => { addToPlaylist()
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        getPlayList()}}/>
               <FolderIcon className="scale-125 playlist text-stone-400"/>
          </div>
     );
}
