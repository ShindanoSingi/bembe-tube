...
const NavBarMiddle = ({
     ...
     return (
          <div className=" bg-[#1E1E1E] flex justify-center gap-16 max-w-full items-center mx-2">
               <div>
               ...
               <div className="flex gap-16">
                    <PlaylistAddIcon className="invisible scale-125 text-stone-400 add-to-playlist md:visible" onClick= {() => { addToPlaylist()
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         getPlayList()}}/>
                    <FolderIcon className="invisible playlist text-stone-400 md:visible"/>
               </div>
