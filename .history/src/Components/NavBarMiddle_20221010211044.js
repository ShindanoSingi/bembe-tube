     ...
     return (
          <div className=" bg-[#1E1E1E] flex justify-center gap-16 max-w-full items-center">
               ...
               <div className="flex gap-16">
                    <PlaylistAddIcon className="scale-125 invisible text-stone-400 add-to-playlist" onClick= {() => { addToPlaylist()
                                                                                                                                                                                                                                                                                                                                                                                                                                              getPlayList()}}/>
                    <FolderIcon className=" playlist invisible text-stone-400"/>
               </div>
