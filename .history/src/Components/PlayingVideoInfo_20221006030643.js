...
function PlayingVideoInfo({videoObject, viewsFunc, getaddToPlaylist}) {
     ...
     return(videoObject.type === "video" && (
          <div class="row gx-5">
               ...
               <div className="flex gap-4 py-1 mx-2">
                    <div>
                         <Avatar className="playing-video-avatar"
                              ...
                              alt=""/>
                         <p className="playing-video-channel text-truncate text-ellipsis">
                              {
                              videoObject.channel.name
                         } </p>
                    </div>
                    ...
                    <div>
                         <h4>
                              <strong>{
                                   videoObject.title.substring(0, 30) + '...'
                              } </strong>
                         </h4>
