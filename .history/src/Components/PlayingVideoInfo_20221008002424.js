...
function PlayingVideoInfo({videoObject, viewsFunc, getaddToPlaylist}) {
     ...
     return(videoObject.type === "video" && (
          <div class="flex text-white justify-evenly p-1 md:p-2 w-screen">
               <div class="flex  md:flex-row w-screen rounded-lg shadow-lg">
                    ...
                    <div class="p-1 flex flex-col visible md:invisible justify-start">
                         <h5 class="text-xs visible md:invisible  mb-2 md:text-lg">
                              {
                    ...
                    <div class="p-1 flex flex-col invisible md:visible justify-start">
                         <h5 class="text-xs visible md:invisible  mb-2 md:text-lg">
                              {
                              videoObject.title.charAt(0) + videoObject.title.substring(1, 80) + "..."
                         }</h5>
                         <ul className="flex text-xs md:text-24 justify-evenly text-[#AAAAAA]">
                              <li>{
                                   viewsFunc(videoObject.views)
