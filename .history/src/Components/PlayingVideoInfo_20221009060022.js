...
function PlayingVideoInfo({videoObject, viewsFunc, getaddToPlaylist}) {
     ...
     return(videoObject.type === "video" ? (
          <div class="flex text-white gap-2 p-1 md:p-2 mx-auto">
               <div class="flex rounded-lg w-screen justify-center">
                    ...
                    <div class="p-1 flex flex-col justify-start">
                         ...
                         <ul className="flex text-xs md:text-24 justify-evenly md:fle md:justify-evenly md:items-center text-[#AAAAAA]">
                              <li>{
