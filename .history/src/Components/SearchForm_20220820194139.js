  ...
  return (
    <div className="flex items-center search-icon-and-input-box">
      <form onSubmit={handleSubmit} className="form">
        ...
        <input
          autoFocus
          className="pl-2 text-sm rounded-lg md:rounded-3xl md:text-2xl w-30 md:w-60 input-box"
      ...
      <GoSearch
        className="relative pt-1 text-md md:text-3xl right-5 md:right-7 searchIcon "
