...
export default function UserLoginIcon({ forwardedRef, userData }) {
  ...
  return (
    <div className="flex justify-between align-items-lg-baseline-baseline user-super-container">
      {/* <div>
      ...
      <Link to="/registerOrSignin">
        <div className="register-login">
          <p className="text-2xl register-text">Login</p>
        </div>
      </Link>

      <div className="username-container">
        <FaUser className="text-3xl user-icon" />
        {!userData.username ? (
