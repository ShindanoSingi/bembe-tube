...
export default function UserLoginIcon({ forwardedRef, userData }) {
  ...
  return (
    <div className="flex gap-2 md:gap-4 align-baseline justify-between user-super-container">
      {/* <div>
      ...
      <Link to="/registerOrSignin">
        <div className="register-login">
          <p className="text-lg md:text-2xl register-text">Login</p>
        </div>
      </Link>

      <div className="username-container">
        <FaUser className="text-lg md:text-2xl user-icon" />
        {/* {!userData.username ? (
