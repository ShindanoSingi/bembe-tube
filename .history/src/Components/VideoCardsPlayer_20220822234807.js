        ...
        (video, index) =>
          video.type === "video" && (
            ...
            >
              <div
                key={index}
                className="flex flex-col items-center w-48 h-40 mb-2 bg-white border rounded-lg shadow-md h-fit md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
              >
                <div className="flex flex-col gap-4 ml-1">
                  ...
                  <div className="flex flex-row gap-1">
                    <img
                      className="object-cover w-48 h-32 rounded-md md:h-32 md:w-md"
