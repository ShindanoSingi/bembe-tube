        ...
        (video, index) =>
          video.type === "video" && (
            ...
            >
              <div
                key={index}
                className="flex flex-col items-center h-40 mb-2 bg-white border rounded-lg shadow-md w-60 md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
              >
