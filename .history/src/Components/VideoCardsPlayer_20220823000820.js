        ...
        (video, index) =>
          video.type === "video" && (
            ...
            >
              <div
                key={index}
                className="flex flex-col items-center mb-2 bg-white border rounded-lg shadow-md h-fit md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
              >
                <div className="object-cover w-48 thumbnail">
                  <img
                    className="object-cover w-48 h-96 md:h-32 md:max-w-xl"
                ...
                <div className="flex flex-col gap-4 ml-1">
                  <div className="text-base title">
                    <h10 class="mb-1 text-md px-4 font-bold tracking-tight text-gray-900">
                      {video.title}
                    </h10>
                  </div>
