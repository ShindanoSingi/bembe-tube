        ...
        (video, index) =>
          video.type === "video" && (
            ...
            >
              <div
                key={index}
                class="flex pl-1 h-fit flex-row mb-2 items-center bg-white rounded-lg border shadow-md md:flex-row md:min-w-full hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
              >
                <div className="">
                  <img
                    className="rounded-l-lg thumbnail"
                ...
                <div className="gap-5 flex-column">
                  <div className="ml-0.5 text-md tracking-tight text-gray-900 text-md">
                    {video.title}
                  </div>
                  ...
                  <div className="flex gap-1 avatar-div">
                    <div className="flex flex-col justify-start channel-name">
                      <img
                        ...
                        alt="channel-icon"
                      />
                      <div class="mb-3 font-normal text-gray-700 px-2 text-xs dark:text-gray-400">
                        {video.channel.name}
                      </div>
                    </div>
