        ...
        (video, index) =>
          video.type === "video" && (
            ...
            >
              <div
                key={index}
                class="flex gap-1 h-fit flex-row mb-2 items-center bg-white rounded-lg border shadow-md md:flex-row md:min-w-full hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
              >
                <div className="">
                  <img
                ...
                <div className="flex gap-2 flex-column">
                  <div className="ml-0.5 text-sm tracking-tight text-gray-900 text-md">
                    {video.title}
                  </div>
                  ...
                  <div className="flex gap-1 avatar-div">
                    <div className="flex flex-col justify-start channel-name">
                      <img
                        ...
                        alt="channel-icon"
                      />
                      <div class="mb-3 font-normal text-gray-700 text-md dark:text-gray-400">
                        {video.channel.name}
                      </div>
                    </div>
                    ...
                    <div class="flex flex-col justify-between p-1 leading-normal">
                      <p class="mb-3 font-normal text-gray-700 text-md dark:text-gray-400">
                        Views: {viewsFunc(video.views)}
                      </p>
                      <p class="mb-3 relative bottom-4 font-normal text-gray-700 text-md dark:text-gray-400">
                        Posted: {video.uploadedAt}
                      </p>
                      <p class="mb-3 font-normal relative bottom-8 text-gray-700 text-md dark:text-gray-400">
