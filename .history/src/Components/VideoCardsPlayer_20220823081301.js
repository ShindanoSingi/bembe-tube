        ...
        (video, index) =>
          video.type === "video" && (
            ...
            >
              <div
                key={index}
                class="flex gap-1 h-fit flex-row mb-2 items-center bg-white rounded-lg border shadow-sm sm:flex-row sm:min-w-full hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
              >
                <div className="">
                  <img
                ...
                <div className="flex gap-2 flex-column">
                  <div className="ml-0.5 text-sm tracking-tight text-gray-900 text-sm">
                    {video.title.toLowerase()}
                  </div>
