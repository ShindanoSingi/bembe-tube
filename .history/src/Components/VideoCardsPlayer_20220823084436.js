        ...
        (video, index) =>
          video.type === "video" && (
            ...
            >
              <div
                key={index}
                class="flex gap-1 h-fit flex-row mb-2 items-center bg-white rounded-lg border shadow-md md:flex-row hover:bg-gray-100 md:w-48 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
              >
                <div className="">
                  <img
