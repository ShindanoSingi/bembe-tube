...
const VideoCards = ({ videos, viewsFunc }) => {
  ...
  return (
    <div className="flex flex-wrap gap-2 overflow-auto lg:overflow-auto lg:absolute lg:right-52 lg:max-h-80 lg:flex-col justify-content-center cards-container">
      {videos.map(
        (video, index) =>
          video.type === "video" && (
            <Link
