...
const VideoCards = ({ videos, viewsFunc }) => {
  ...
  return (
    <div className="flex flex-wrap mt-1 overflow-auto md:flex md:fle-row md:flex-wrap md:gap-2 md:mt-8 lg:overflow-auto lg:flex-row md:flex-row justify-content cards-container">
      {videos.map(
        (video, index) =>
          video.type === "video" && (
            <Link
