...
const VideoCards = ({videos, viewsFunc}) => {
     ...
     return !videos ? <Wait/>: (<div className="flex flex-wrap mt-1 overflow-auto lg:left-72 bg-[black] min-h-full  md:flex md:fle-row md:flex-wrap md:gap-1 lg:flex md:mt-8 lg:overflow-auto lg:flex-row md:flex-row justify-content ">
          ...
          videos.map((video, index) => video.type === "video" && (<Link key={
               ...
               <div class="flex justify-center px-1 relative top-[40rem] max-h-[20rem] overflow-auto">
                    key={index}

                    <div class="flex flex-col md:flex-row md:max-w-xl mb-1  bg-white shadow-lg">
                         <img class=" w-full h-96 md:h-auto object-cover md:w-48 md:rounded-none md:rounded-l-lg" src="https://mdbootstrap.com/wp-content/uploads/2020/06/vertical.jpg" alt=""/>
