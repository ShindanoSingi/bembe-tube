          ...
          <div className="flex fixed flex-wrap no-scrollbar gap-2 top-[21rem] py-2 max-h-[10rem]  mx-auto overflow-scroll lg:left-72 bg-[#1E1E1E] min-h-full  md:flex md:fle-row md:flex-wrap md:gap-1 lg:flex md:mt-8 lg:overflow-auto lg:flex-row md:flex-row justify-content ">
               ...
               videos.map((video, index) => video.type === "video" && (
                    <Link key={
                         ...
                         <div class="flex justify-center max-w-2xl mx-1"
                              key={index}>
                              <div class="flex h-[8rem] gap-2 md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg">
                                   ...
                                   <div className="flex gap-2 py-2 flex-column">
                                        <p className=" ml-0.5  lg:w-60 text-sm text-gray-900">
                                             {
                                             video.title.charAt(0).toUpperCase() + video.title.toLowerCase().substring(1, 38) + "..."
                                        } </p>

                                        <div className="flex gap-1 avatar-div">
                                             <div className="hidden md:flex md:flex-col md:justify-start channel-name">
