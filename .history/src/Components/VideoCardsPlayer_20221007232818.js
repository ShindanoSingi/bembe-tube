...
const VideoCards = ({videos, viewsFunc}) => {
     ...
     return videos.length < 1 ? <Wait/>: (
          <div className="flex fixed flex-wrap no-scrollbar gap-2 top-[25rem] md:fixed md:top-[46rem] max-h-[20.5vh] mb-2  mx-auto overflow-scroll lg:left-72  md:flex  md:flex-wrap md:gap-1 lg:flex md:mt-8 lg:overflow-auto lg:flex-row md:flex-row justify-content ">
               {
