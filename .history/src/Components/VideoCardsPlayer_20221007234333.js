          ...
          <div className="flex fixed flex-wrap no-scrollbar gap-2 top-[25rem] md:fixed md:top-[35.5rem] max-h-[28rem] mb-2  mx-auto overflow-scroll lg:left-72  md:flex  md:flex-wrap md:gap-1 lg:flex md:mt-8 lg:overflow-auto lg:flex-row md:flex-row justify-content ">
               ...
               videos.map((video, index) => video.type === "video" && (
                    <Link key={
                         ...
                         <div class="flex justify-center md:grid  max-w-2xl md:w-[30rem] mx-1 border border-stone-900 rounded-lg"
                              key={index}>
                              <div class="flex h-[8rem] w-[96.5vw] gap-2 md:flex-row md:max-w-screen rounded-lg bg-[#1E1E1E] ">
