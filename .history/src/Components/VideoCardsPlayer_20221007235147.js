...
const VideoCards = ({videos, viewsFunc}) => {
     ...
     return videos.length < 1 ? <Wait/>: (
          <div className="flex fixed flex-wrap no-scrollbar gap-2 top-[25rem] md:fixed md:top-[35.5rem] max-h-[28rem] mb-2  mx-auto md:items-center overflow-scroll lg:left-72  md:flex  md:flex-wrap md:gap-1 lg:flex md:mt-8 lg:overflow-auto lg:flex-row md:flex-row justify-content ">
               {
               videos.map((video, index) => video.type === "video" && (
                    <Link key={
                         ...
                         <div class="flex justify-center md:grid  w-[98vw] md:w-[98vw] mx-1 md:mx-auto border border-stone-900 rounded-lg"
                              key={index}>
