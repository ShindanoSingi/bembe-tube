...
const VideoCards = ({videos, viewsFunc}) => {
     ...
     return videos.length < 1 ? <Wait/>: (
          <div className="cards-container flex fixed flex-wrap no-scrollbar gap-2  top-[20.5rem] md:fixed md:top-[35.5rem] max-h-[42rem] mb-2 md:flex overflow-scroll lg:left-72  md:items-center  md:flex-wrap md:gap-1 lg:flex md:mt-8 lg:overflow-auto lg:flex-row md:mx-1 md:flex-row justify-content ">
               {
               videos.map((video, index) => video.type === "video" && (
                    <Link key={
                         ...
                         <div class="flex justify-center md:grid card  w-[98vw] md:w-[98vw] mx-1 border border-stone-900 rounded-lg"
                              key={index}>
                              <div class="flex h-[8rem] w-[96.5vw] md:w-20rem gap-2 md:flex-row md:w-screen rounded-lg bg-[#1E1E1E] ">
