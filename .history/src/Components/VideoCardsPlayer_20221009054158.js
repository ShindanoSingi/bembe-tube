                         ...
                         <div class="flex justify-center md:grid card  w-[98vw]   md:w-[98vw] mx-1  rounded-lg"
                              ...
                              <div class="flex h-[8rem] w-[96.5vw] md:w-[97.8vw] lg:max-w-lg  gap-2 md:flex-row  rounded-lg bg-[#1E1E1E] ">
                                   ...
                                   <div className="flex gap-2 py-2 flex-column">
                                        ...
                                        <p className=" ml-0.5 md:visible invisible  lg:w-60 text-sm text-white">
                                             {
                                             video.title.charAt(0).toUpperCase() + video.title.toLowerCase().substring(1, 198) + "..."
                                        } </p>
                                        ...
                                        <div className="flex gap-[0.1rem]">
                                             ...
                                             <a className="channel-id-player"
                                                  ...
                                                  target="_blabk"></a>
                                             <div class="flex flex-col md;flex  md:flex-row justify-between leading-normal">
