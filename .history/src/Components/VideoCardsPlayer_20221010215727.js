...
const VideoCards = ({videos, viewsFunc}) => {
     ...
     return videos.length < 1 ? <Wait/>: (
          <div className="cards-container flex fixed flex-wrap no-scrollbar gap-2  top-[20.5rem] md:fixed lg:relative md:mx-auto  max-h-[42rem] mb-2  overflow-scroll  md:flex-wrap justify-content">
               {
