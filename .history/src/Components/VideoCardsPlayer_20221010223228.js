               ...
               videos.map((video, index) => video.type === "video" && (
                    <Link key={
                         ...
                         <div class="grid w-[98vw] md:w-[48.5vw] xl:w-[30rem] mx-1  rounded-lg md:border-none"
                              key={index}>
                              <div class="flex h-[8rem] w-[96.5vw] single-card  gap-2 md:flex-row   bg-[#1E1E1E] ">
                                   <img className="w-[6rem] videoThumbnail h-[8rem] md:h-auto object-cover md:w-48 rounded-l-lg md:rounded-none lg:rounded-none"
                                        src={
                                             video.thumbnail.url
                                        }
                                        alt=""
