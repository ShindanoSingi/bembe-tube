...
const VideoCards = ({videos, viewsFunc}) => {
     ...
     return videos.length < 1 ? <Wait/>: (
          <div className="cards-container flex fixed flex-wrap no-scrollbar gap-2 xl:top-[0rem]  xl:fixed xl:left-[85rem]  top-[20.5rem] md:fixed md:mx-auto  max-h-[42rem] mb-2  overflow-scroll   md:flex-wrap  lg:flex lg:flex-col xl:flex xl:flex-col  lg:overflow-auto  justify-content ">
               {
