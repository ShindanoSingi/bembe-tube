...
const VideoCards = ({videos, viewsFunc}) => {
     ...
     return videos.length < 1 ? <Wait/>: (
          <div className="cards-container flex relative flex-wrap no-scrollbar gap-2 xl:bottom-[10rem] lg:left-[5rem]  top-[0.5rem]  md:mx-auto  max-h-[42rem] mb-2  overflow-scroll   md:flex-wrap  lg:flex lg:flex-col xl:flex xl:flex-col  lg:overflow-auto  justify-content ">
               {
