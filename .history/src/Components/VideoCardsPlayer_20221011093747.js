                                   ...
                                   <div className="flex flex-col gap-2 py-2">
                                        ...
                                        <div className="flex gap-[0.1rem]">
                                             ...
                                             <ul class="flex flex-col md:flex  md:justify-between justify-between leading-normal">
                                                  <li class="mb-3 font-normal text-xs dark:text-gray-400">
                                                       Views: {
                                                       viewsFunc(video.views)
                                                  } </li>
                                                  <li class="mb-3 relative bottom-4 font-normal text-xs dark:text-gray-400">
                                                       Posted: {
                                                       video.uploadedAt
                                                  } </li>
                                                  <li class="mb-3 font-normal relative bottom-8 text-xs dark:text-gray-400">
                                                       Duration: {
