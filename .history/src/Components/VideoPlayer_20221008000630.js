...
function VideoPlayer({
     ...
     return (
          <div className="grid min-h-screen">
               <div className="fixed flex flex-col min-h-full mx-auto">
                    <Nav handleChange={handleChange}
                         handleSubmit={handleSubmit}
                         searchedString={searchedString}
                         userData={userData}
                         getUserData={getUserData}/> {/* <div className="flex flex-col mt-5 lg:flex-row md:gap-2 col lg:px-1"> */}
                    {/* <div className="flex flex-col gap-2"> */}
                    <VideoIframe videos={videos}
                         getVideoObject={getVideoObject}/>
                    <NavBarMiddle videoObject={videoObject}
                         viewsFunc={viewsFunc}
