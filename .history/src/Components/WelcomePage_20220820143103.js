...
const WelcomePage = () => {
  return (
    <div className="h-screen welcomePage ">
      <div className="absolute justify-center mt-8 transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 center flex-column ">
        <p className="text-3xl text-center welcome">Welcome</p>
        <p className="text-center click-on-go">Please click on "Go"</p>
      </div>
