...
const WelcomePage = () => {
  return (
    <div className="h-screen welcomePage ">
      <div className="absolute justify-center transform -translate-x-1/2 top-20 left-1/2 center flex-column ">
        <p className="text-3xl text-center welcome">Welcome</p>
        <p className="text-base text-center click-on-go">
          Please click on "Go" button.
        </p>
      </div>
      <div class="w-full justify-center h-screen flex">
        <img
          ...
          alt="Home Page mage"
        />
        <div className="absolute flex justify-center mt-4 text-2xl text-center bg-blue-500 rounded-md w-25 -botton-1/4">
