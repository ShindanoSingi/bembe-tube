...
const WelcomePage = () => {
  return (
    <div className="h-screen welcomePage ">
      <div className="absolute justify-center transform -translate-x-1/2 inset-y-5 md:top-20 left-1/2 center flex-column ">
      ...
      <div class="w-full justify-center h-screen flex">
        <img
          className="object-center mt-1/2 h-60"
          src={require("../Components/Images/HomePage.png")}
          alt="Home Page mage"
        />
        <div className="absolute flex justify-center mt-5 text-2xl text-center bg-blue-500 rounded-md w-25 top-3/4">
