...
const WelcomePage = () => {
     return (
          <div className="grid items-center h-screen gap-16 place-content-center">
               ...
               <img className="object-center m-auto h-60 md:h-1/2"
                    ...
                    alt="Home Page mage"/>
               <div className="w-[5rem] mx-auto bg-blue-500 flex justify-center rounded-md py-2">
                    <Link to="/videoPlayer/:id">
                         <button className="text-lg md:text-4xl">
                              Go
                         </button>
                    </Link>
               </div>
