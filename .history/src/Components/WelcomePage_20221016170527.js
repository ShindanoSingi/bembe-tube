...
const WelcomePage = () => {
  return (
    <div className="flex flex-col h-screen welcomePage ">
      <div
        id="top-text"
      ...
      >
        ...
        <div className="flex justify-center mt-5 text-2xl text-center bg-blue-500 rounded-md w-15 md:w-25 md:py-2 lg:py-3 top-3/4 button">
