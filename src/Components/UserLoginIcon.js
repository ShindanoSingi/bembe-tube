...
export default function UserLoginIcon({forwardedRef, userData}) {
     ...
     return (
          <div className="flex items-center justify-between gap-1 md:gap-8 lg:gap-8 user-super-container">
               {/* <Link to="/registerOrSignin"> */}
               <div className="register-login">
                    <p className="text-white text-md md:text-2xl register-text">Login</p>
               </div>
               {/* </Link> */}
